...
var extRange_TopLevel = []protoiface.ExtensionRangeV1{
	{Start: 100, End: 1000},
}

// Deprecated: Use TopLevel.ProtoReflect.Descriptor.ExtensionRanges instead.
func (*TopLevel) ExtensionRangeArray() []protoiface.ExtensionRangeV1 {
